...
/*
  Copyright 2010 Scott MacVicar
   ...
   limitations under the License.
    ...
    https://github.com/AramZS/opengraph
...
class OpenGraph implements Iterator
{
   ...
   */
    ...
    curl_setopt($curl, CURLOPT_COOKIEFILE, $cookie_path); //you can change this path to whatever you want.
    curl_setopt($curl, CURLOPT_COOKIEJAR, $cookie_path); //you can change this path to whatever you want.
